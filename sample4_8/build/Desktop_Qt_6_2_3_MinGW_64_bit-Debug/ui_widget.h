...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        lcdHour->setProperty("value", QVariant(66.000000000000000));
        ...
        lcdMin->setProperty("value", QVariant(66.000000000000000));
        ...
        lcdSec->setProperty("value", QVariant(66.000000000000000));
